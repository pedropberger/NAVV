...
for (categoria in categorias) {
  ...
  df_filtrado <- df %>%
    filter(Orgao == categoria) %>%
    select(Assunto_Gampes, Janeiro, Fevereiro, Março, Abril, Maio, Junho, Julho, Agosto, Setembro, Outubro, Novembro, Dezembro)
